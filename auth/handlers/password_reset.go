...
import (
	...
	password_reset_service "lem-be/auth/services"
...
type passwordResetHandler struct {
	passwordResetService password_reset_service.PasswordResetService
}

func NewPasswordResetHandler(passwordResetService password_reset_service.PasswordResetService) PasswordResetHandler {
...
func (h *passwordResetHandler) HandleForgotPassword(c *gin.Context) {
	var req auth_models.ForgotPasswordRequest
...
func (h *passwordResetHandler) HandleVerifyOTP(c *gin.Context) {
	var req auth_models.VerifyOTPRequest
...
func (h *passwordResetHandler) HandleResetPassword(c *gin.Context) {
	var req auth_models.ResetPasswordRequest
